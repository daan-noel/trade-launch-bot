...
const FIELDS: ParamField[] = [
  ...
  { column: 'bucket_width_sol', group: 'fingerprint', section: 'fingerprint', kind: 'float', required: false, label: 'Bucket Size (SOL)', helpKey: 'bucketWidth', unit: '◎', step: '0.01', min: 0, nullable: true },
  ...
  { column: 'p_entry_min_net_buy_sol', group: 'entry', section: 'entry', kind: 'float', required: false, comboKey: 'entry_min_net_buy_sol', label: 'Min Net Buy SOL', helpKey: 'minNetBuySol', unit: '◎', step: '0.01', nullable: true },

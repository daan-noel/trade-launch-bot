...
export const ruleColumns: ColumnDef<RuleRecord>[] = [
    ...
    },
    {
      ...
      group: 'token_fingerprint',
      sortable: true,
      render: (r) => dashF(r.p_token_max_cost_lamports ?? 0, 3),
      sortValue: (r) => r.p_token_max_cost_lamports ?? 0,
      searchValue: (r) => String(r.p_token_max_cost_lamports ?? ''),
    },
    {
      key: 'spendable',
      label: 'Spendable',
      ...
      group: 'token_fingerprint',
      sortable: true,
      render: (r) => dashF(r.p_token_spendable_lamports_in ?? 0, 3),
      sortValue: (r) => r.p_token_spendable_lamports_in ?? 0,
      searchValue: (r) => String(r.p_token_spendable_lamports_in ?? ''),
    },
    {
      key: 'labels',
      label: 'Labels',

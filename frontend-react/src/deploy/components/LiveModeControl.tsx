...
import { useGetLiveModeQuery, useSetLiveModeMutation } from '@deploy/store/deployEndpoints';

/**
 * Deploy-only LIVE/DEAD kill switch for the header right slot. Owns the
 * live-mode query + mutation so the analysis build (which has no ingest/trading

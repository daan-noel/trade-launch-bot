...
import { analysisColumns, creatorColumns } from '@analysis/components/analysis/analysisColumns';
    ...
    <div>
      <div className="mb-3.5 flex items-center gap-2.5">
        ...
        <Badge variant="primary" className="font-mono">
          {creatorTotal} creators Â· {resultTotal} results
        </Badge>
      </div>
      ...
      {tab === 'creators' && (
        <>
          {creatorLoad && <p className="text-text-dim">Loading creator profilesâ€¦</p>}
      ...
      {tab === 'results' && (
        <>
          {resultLoad && <p className="text-text-dim">Loading analysis resultsâ€¦</p>}

import { TPSL1_AXES } from '@analysis/components/sweep/groupedTypes';
import { STORAGE_KEYS } from 'lib/storage';
import { GroupedSweepView } from './GroupedSweepView';

/** TPSL1 swept knobs â€” the exit ladder only (no scalp entry gates, no cohort
...
/** TPSL1 grouped sweep â€” the exit-ladder-only param space. Reuses the generic
...
export function Tpsl1GroupedSweepPage() {
  return (
    <GroupedSweepView
      ...
      title="Grouped Param Sweep Â· TPSL1"
    />
  );
}

...
/**
 * Analysis (workstation) nav. Violet accent, no live-mode toggle (there is no
 * ingest/trading to switch). Adds the Analysis pages + strategy authoring +
 * grouped sweeps; omits the deploy-only live-trading entries.
 */
export const analysisNav: NavConfig = {
  accent: 'violet',
  items: [

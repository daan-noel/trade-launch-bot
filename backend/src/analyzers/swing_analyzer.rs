...
// `ChainStats` moved to `backend-core::analyzers` (shared with the core token-list
// sort); re-exported so `crate::analyzers::swing_analyzer::ChainStats` paths resolve.
pub use backend_core::analyzers::ChainStats;

...
use crate::{
    models::{PaperRunStatus, Position, Tpsl1StrategyRule},
...
fn lifecycle_label(rule: &Tpsl1StrategyRule, open_positions: i64, paper_status: Option<PaperRunStatus>) -> &'static str {
    if rule.is_active {
        "Active"
...
impl RuleResponse {
    ...
    fn build(r: Tpsl1StrategyRule, open_positions: i64, paper_status: Option<PaperRunStatus>) -> Self {
...
async fn rule_response(app_state: &Arc<AppState>, rule: Tpsl1StrategyRule) -> RuleResponse {

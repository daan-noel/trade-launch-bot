...
impl RuleResponse {
    ...
    fn build(r: Tpsl2Rule, open_positions: i64, paper_status: Option<PaperRunStatus>) -> Self {
...
/// is normally far from binding; when it is hit we log (no silent cap) rather than

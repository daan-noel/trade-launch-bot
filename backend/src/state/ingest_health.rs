...
/// Floor for the watchdog stall window. Below this a normal burst lull could trip
/// a process restart, so the API clamps writes here and the watchdog re-applies it
/// defensively against a hand-edited DB row.
pub const WATCHDOG_STALL_TIMEOUT_FLOOR_SECS: u64 = 30;

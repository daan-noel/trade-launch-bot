...
export const ruleColumns: ColumnDef<RuleRecord>[] = [
    ...
    },
    {
      ...
      sortable: true,
      render: (r) => dashF(r.p_token_initial_buy_sol ?? 0, 6),
    ...
    },
    {
      ...
      group: 'token_fingerprint',
      sortable: true,
      render: (r) => dashF(r.p_token_first_slot_buy_sol ?? 0, 6),
      sortValue: (r) => r.p_token_first_slot_buy_sol ?? 0,
      searchValue: (r) => String(r.p_token_first_slot_buy_sol ?? ''),
    },
    {
      key: 'first_slot_sell',
      label: '1st Sell',
      group: 'token_fingerprint',
      sortable: true,
      render: (r) => dashF(r.p_token_first_slot_sell_sol ?? 0, 6),
      sortValue: (r) => r.p_token_first_slot_sell_sol ?? 0,
      searchValue: (r) => String(r.p_token_first_slot_sell_sol ?? ''),
    },
    {
      key: 'cu_limit',
      label: 'CU Lim',
    ...
    },
    {
      ...
      group: 'sizing',
      sortable: true,
      render: (r) => dashF(r.buy_amount_sol, 6),
    ...
    },
    {
      key: 'min_net_buy',
      label: 'Min Net Buy',
      tooltip: paramTip('minNetBuySol'),
      group: 'entry',
      sortable: true,
      render: (r) => dashF(r.p_entry_min_net_buy_sol ?? 0, 3),
      sortValue: (r) => r.p_entry_min_net_buy_sol ?? 0,
      searchValue: (r) => String(r.p_entry_min_net_buy_sol ?? ''),
    },
    {
      key: 'pullback',
      label: 'Pullback',

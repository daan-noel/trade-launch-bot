...
/** Cooperative cancel for the in-flight family-search job. */
export async function cancelFamilySearch(): Promise<void> {
  await request(`${API_BASE}/api/strategies/family-search/cancel`, { method: 'POST' });
}

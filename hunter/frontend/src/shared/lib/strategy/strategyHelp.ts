...
export const GROUP_HELP: Record<string, HelpTip> = {
  ...
  m_flow_window: {
    ...
    body: [
      ...
      '(e.g. 10) or window_size_slots (e.g. 30) — plus an optional window_lag.',
      'Kind: dynamic.',
    ].join('\n'),
  },
  m_flow_split: {
  ...
  m_flow_split_window: {
    ...
    body: [
      'Same split as m_flow_split, but over a trailing window (window_size_sec or',
      'window_size_slots).',
...
export const METRIC_HELP: Record<string, HelpTip> = {
  ...
  buy_share: {
    ...
    body: [
      ...
      'silence. Needs a window size (window_size_sec or window_size_slots).',
    ].join('\n'),
  },
  unique_wallets: {
    ...
    body: [
      ...
      '',
      'Needs a window size (window_size_sec or window_size_slots). Wallet-keyed: an',
  ...
  trade_count: {
    ...
    body: [
      ...
      '',
      'Needs a window size (window_size_sec or window_size_slots).',
    ].join('\n'),
  },
  stall: {
...
export const STRICT_PARAM_HELP: Record<string, HelpTip> = {
  ...
  burst_size_slots: {
    ...
    body: [
      ...
      '',
      'The canonical shape is burst 1 / window 30: the current slot against the',
  ...
  window_size_sec: {
    ...
    body: [
      ...
      '',
      'Every dynamic group needs EXACTLY ONE size — this or window_size_slots, never',
      'both and never neither. The window is the closed interval',
  ...
  window_lag: {
    ...
    body: [
      'How many units (seconds or slots, matching the size param) back from now the',
      'window stops. 0 — the default — means it ends at now.',
      '',
      ...
      'lag 1 on a slot window is exactly that: the burst is size 1 / lag 0 and the',

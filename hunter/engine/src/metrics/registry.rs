...
const fn m(
    ...
    MetricSpec { id, family, name, unit, summary, example, note, tags, tag_level, spans, monotonic, eq_tolerance, hue }
}
...
pub const METRICS: &[MetricSpec] = &[
    ...
    m(M::OnCurve, F::State, "on_curve", U::Flag,
    ...
    // ── m_price ──
    m(M::RisePct, F::Price, "rise_pct", U::Percent,
    ...
    m(M::TrailPct, F::Price, "trail_pct", U::Percent,
    ...
    m(M::StallSec, F::Price, "stall_sec", U::Seconds,
    ...
    m(M::NetSol, F::Flow, "net_sol", U::Sol,
    ...
    m(M::GrossSol, F::Flow, "gross_sol", U::Sol,
    ...
    m(M::BuyCount, F::Flow, "buy_count", U::Count,
    ...
    m(M::SellCount, F::Flow, "sell_count", U::Count,
    ...
    m(M::TradeCount, F::Flow, "trade_count", U::Count,
    ...
    m(M::BuyTxCount, F::Flow, "buy_tx_count", U::Count,
    ...
    m(M::SellTxCount, F::Flow, "sell_tx_count", U::Count,
    ...
    m(M::BuySharePct, F::Flow, "buy_share_pct", U::Percent,
    ...
    m(M::TagSharePct, F::Flow, "tag_share_pct", U::Percent,
    ...
    m(M::SliceTradeSharePct, F::Flow, "slice_trade_share_pct", U::Percent,
    ...
    m(M::SliceSolSharePct, F::Flow, "slice_sol_share_pct", U::Percent,
    ...
    // ── m_holdings ──
    m(M::ProfitSol, F::Holdings, "profit_sol", U::Sol,
    ...
    m(M::BagSharePct, F::Holdings, "bag_share_pct", U::Percent,
    ...
    // ── m_crowd ──
    m(M::UniqueWallets, F::Crowd, "unique_wallets", U::Count,
    ...
    m(M::TradesPerWallet, F::Crowd, "trades_per_wallet", U::Count,
    ...
    m(M::UniqueIxShapes, F::Crowd, "unique_ix_shapes", U::Count,
    ...
    m(M::UniqueIxTemplates, F::Crowd, "unique_ix_templates", U::Count,
    ...
    m(M::BuyerCount, F::Crowd, "buyer_count", U::Count,
    ...
    m(M::BuyerIsNew, F::Crowd, "buyer_is_new", U::Flag,
    ...
    // ── m_print ──
    m(M::SinceBuySec, F::Print, "since_buy_sec", U::Seconds,
    ...
    // ── m_slot ──
    m(M::SlotThisJoined, F::Slot, "this_joined", U::Flag,
    ...
    m(M::SlotThisHasTag, F::Slot, "this_has_tag", U::Flag,
    ...
    m(M::SlotSameTemplateBuyCount, F::Slot, "same_template_buy_count", U::Count,
    ...
    m(M::SlotSameTemplateBuySol, F::Slot, "same_template_buy_sol", U::Sol,
    ...
    m(M::SlotSameTemplateWalletCount, F::Slot, "same_template_wallet_count", U::Count,
    ...
    m(M::SlotTemplateCount, F::Slot, "template_count", U::Count,
    ...
    m(M::SlotBuyCount, F::Slot, "buy_count", U::Count,
    ...
    m(M::SlotBuySol, F::Slot, "buy_sol", U::Sol,
    ...
    m(M::SlotWalletCount, F::Slot, "wallet_count", U::Count,
    ...
    m(M::SlotBuySharePct, F::Slot, "buy_share_pct", U::Percent,
    ...
    m(M::SlotHasNewWallet, F::Slot, "has_new_wallet", U::Flag,
    ...
    m(M::SlotHasUnknownWallet, F::Slot, "has_unknown_wallet", U::Flag,
    ...
    m(M::SlotPacked, F::Slot, "packed", U::Flag,
    ...
    m(M::SlotLiquidityBeforeSol, F::Slot, "liquidity_before_sol", U::Sol,
    ...
    m(M::SlotTrailBeforePct, F::Slot, "trail_before_pct", U::Percent,
    ...
    // ── m_wave ──
    m(M::WaveThisJoined, F::Wave, "this_joined", U::Flag,
    ...
    m(M::WaveThisHasTag, F::Wave, "this_has_tag", U::Flag,
    ...
    m(M::WaveGapSlots, F::Wave, "gap_slots", U::Count,
    ...
    m(M::WaveAllNewWallets, F::Wave, "all_new_wallets", U::Flag,
    ...
    m(M::WaveHasUnknownWallet, F::Wave, "has_unknown_wallet", U::Flag,
    ...
    m(M::WaveThisTipLamports, F::Wave, "this_tip_lamports", U::Lamports,
    ...
    m(M::WaveHasTxGap, F::Wave, "has_tx_gap", U::Flag,
    ...
    m(M::WaveTipBandSeen, F::Wave, "tip_band_seen", U::Flag,
    ...
    m(M::BouncePct, F::Position, "bounce_pct", U::Percent,
    ...
    m(M::RoomTakenPct, F::Position, "room_taken_pct", U::Percent,
    ...
    m(M::StageSec, F::Position, "stage_sec", U::Seconds,

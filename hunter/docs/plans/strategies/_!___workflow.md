...
Every door-behind sentence waits on clients, not terms: a week of prints is about 20 creation
builds and one carries each book; thirty days is about 150 (evidence 3.1a). The history does not
exist before 2026-09-01 in Postgres or the lake, so the tape grows one day a day and reaches
thirty days around 2026-09-30. Then the frozen slow-wall burst-start cell re-runs unchanged; the
...
| burst START on the mid-tape traders' coins | +2.6 .. +6.7 %/trade on every exit there, red on the full tape (evidence 5.4) | a public door; every public door tried is red (6.4, 6.9) |
| machine census, exact `ix_labels` | the best structures reach the toll in money alone, on a price-path parent | a door and an exit, on a parent that is not the price path |

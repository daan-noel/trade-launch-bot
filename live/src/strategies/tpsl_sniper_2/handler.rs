...
use trading_core::models::{Tpsl2Rule, Token};
use uuid::Uuid;
...
pub struct TPSL2StrategyHandler {
    rules: Arc<Vec<Tpsl2Rule>>,
}

impl TPSL2StrategyHandler {
    pub fn new(rules: Arc<Vec<Tpsl2Rule>>) -> Self {
        Self { rules }
    }
    ...
    pub fn get_rule(&self, rule_id: Uuid) -> Option<&Tpsl2Rule> {

...
export const CHART_COLORS = {
  ...
  barSelected: '#fddc3b',
  /** Fixed marker color for the launcher's own ("mine") managed wallet class, so
   *  it's recognizable at a glance among the other role-colored wallet markers. */
  mine: '#fbbf24',
  /** Glow + outer ring for a focused/highlighted wallet marker. */

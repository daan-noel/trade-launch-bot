...
use backend_core::models::{token::Token, token_info::TokenInfo, trade::Trade};
...
mod tests {
    ...
    async fn for_each_seed_mint_caps_history_and_carries_lifetime_aggregates() {
        ...
        for i in 1..=5i64 {
            ...
            sigs.push(sig.clone());
            let mut t = backend_core::models::trade::Trade::new(
                mint.clone(),
                wallet.clone(),
                TradeType::Buy,
                i as f64,                          // sol_amount
        ...
        let mut seen: Vec<(String, Vec<backend_core::models::trade::Trade>, SeedAgg)> = Vec::new();
        trade_repo
